...
public final class CustomTrust {
    ...
    private static SSLContext trustManagerForCertificates(InputStream in)
        ...
        char[] password = null;
        if (!TextUtils.isEmpty(CLIENT_KET_PASSWORD) && !CLIENT_KET_PASSWORD.equals("")){
            password = CLIENT_KET_PASSWORD.toCharArray(); // Any password will work.
        }
    ...
    public static SSLSocketFactory getSslSocketFactory(InputStream certificate, Object object, Object object1) {
       try{
           SSLContext sslContext =  trustManagerForCertificates(certificate); //SSLContext.getInstance("TLS");
